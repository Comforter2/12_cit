...
cit_spec  =
  ...
  decision_tree(tree_depth = tune()) %>% #every decision tree model has a tree_depth hyperparameter 
...
>>>>>>> 42475ac17a6ee8092743f2a3e2e8d2c8800b40fb
...
```
Why the 4 horizontal lines? Why parallel lines?
...
Y axis is strength. Greater fiber strength was observed when solar radiation in July was < 398 W/m2 and vapor pressure in June was > 2130 Pa (terminal node 4).    
